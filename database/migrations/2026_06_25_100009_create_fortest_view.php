...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<'SQL'
CREATE OR REPLACE VIEW "ForTest" ("FORECAST_MONTH", "PRODUCT_NO", "PRODUCT_NAME", "FORECAST_UNITS") AS
  WITH params AS (
  SELECT
    -- Get the maximum year in the data and add 1 (forecast next year)
...
SQL
    ...
    {
        DB::unprepared('DROP VIEW "ForTest"');
    }
};
